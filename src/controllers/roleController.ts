...
export async function getRolesById(req: Request, res: Response, roleId: string): Promise<void> {
  try {
...
export async function deleteRole(req: Request, res: Response, roleId: string): Promise<void> {
  try {
    const role = await prismaClient.role.findUnique({ where: { id: roleId } });
