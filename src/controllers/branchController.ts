  ...
  try {
    ...
    if (!name) {
      res
        ...
        .json(errorJson('Name Parameter is required', null));
      return;
    }
    ...
    res
      ...
      .json(successJson('Branch Updated Successfully', 1));
  } catch (error) {
    res
...
export async function deleteBranch(req: Request, res: Response): Promise<void> {
  try {
    ...
    res
      ...
      .send(successJson('Branch Deleted Succesfully!', 1));
  } catch (error) {
    res
  ...
  try {
    ...
    if (!branch) {
      res
        ...
        .json(errorJson('Branch not found', null));
      return;
    }

    res
      .status(STATUS_CODES.SELECT_SUCCESS)
      .json(successJson('Get branch SuccessFull!', branch));
  } catch (error) {
    res
      .status(STATUS_CODES.SELECT_FAILURE)
      .json(errorJson('Internal Server Error', null));
...
export async function getAllBranchesIdName(
  req: Request,
  res: Response
): Promise<void> {
  try {
    ...
    res
      .status(STATUS_CODES.SELECT_SUCCESS)
      .json(successJson('Get Branches SuccessFul', branches));
  } catch (error) {
    res
      .status(STATUS_CODES.SELECT_FAILURE)
      .json(errorJson('Internal server error', null));
...
export async function createBranch(req: Request, res: Response): Promise<void> {
  try {
    ...
    res
      ...
      .json(successJson('Branch Created successfully!', newBranch.id));
  } catch (error) {
    res
