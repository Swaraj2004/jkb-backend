...
import { createContactEnquiry, getContactEnquiry, getCarrerPrediction, getBranchPrediction, createFacebookEnquiry, getFacebookEnquiry, getQnaEnquiry, getBranchEnquiry } from '../controllers/miscellaneousController';
...
router.post("/facebook-enquiries", (req: Request, res: Response): Promise<void> => {
