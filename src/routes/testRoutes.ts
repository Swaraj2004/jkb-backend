...
router.post(
  '/test/submit/:test_submission_id',
  authMiddleware,
  authorizeRoles([ADMIN_ROLE, PROFESSOR_ROLE, STUDENT_ROLE]),
  (req: Request, res: Response): Promise<void> => {
